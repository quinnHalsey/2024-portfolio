 ...
 * the project exists in the `featuredProjects` object and verifies if the URL matches the `slug`
 * of the project.
 *
 ...
 *
 * @example
 * // Assume featuredProjects contains a project with the route '/my-project'
...
export const getProjectFromPath = (pathname: string) => {
    ...
    const project = featuredProjects[parsedPath];
